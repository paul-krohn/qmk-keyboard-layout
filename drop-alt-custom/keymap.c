...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS, LCA_T(KC_HOME), \
    ...
    [1] = LAYOUT(
        ...
        KC_CAPS, RGB_RMOD,RGB_VAD, RGB_MOD, RGB_HUD, RGB_SAD, _______, _______, _______, _______, _______, _______,          _______, KC_HOME, \
        _______, RGB_TOG, RGB_M_P, _______, _______, MD_BOOT, NK_TOGG, DBG_TOG, _______, _______, _______, _______,          _______, KC_END, \
        _______, _______, _______,                            _______,                            _______, _______, _______, _______, _______ \
    ),
    [2] = LAYOUT(
       /* There are a few keys that can be made more Mac-like: brightness up/down (f1/f2), media previous (f7), play/pause (f8), and media next (f9)
...
void matrix_init_user(void) {
  // for $reasons, the macro/constant meaning "solid" can't be included? so `2` is hard-coded here.
  rgblight_mode(2);
